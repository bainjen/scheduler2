...
storiesOf("DayListItem", module) //Initiates Storybook and registers DayListItem component
  ...
  .add("Unselected", () => <DayListItem name="Monday" spots={5} />) //call add() once for each test state to generate a story
  .add("Selected", () => <DayListItem name="Monday" spots={5} selected />)
  .add("Full", () => <DayListItem name="Monday" spots={0} />)
  .add("Clickable", () => (
    <DayListItem name="Tuesday" setDay={action("setDay")} spots={5} /> //action() creates a callback that appears in the actions panel when clicked
  ));
